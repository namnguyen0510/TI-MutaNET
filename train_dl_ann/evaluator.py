...
def main(embedding,
    ...
    checkpoint_dirc = 'result_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(embedding, seed, bow_threshold, gene_threshold, hid_dim, out_dim, n_hid_layers, dropout, lr, alpha, gamma)
    try:
    ...
    #n_muta = np.array([len(x.split())/3 for x in muta])
    #n_muta = (n_muta - n_muta.min())/( n_muta.max()- n_muta.min())
    #n_muta = n_muta.reshape(-1,1)
